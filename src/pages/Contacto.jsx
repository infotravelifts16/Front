        ...
        >
          <div className="grid grid-cols-1 text-center text-white px-12 md:px-12">
           {/*  <h1 className="font-Amatic hover:text-teal-800 text-8xl font-black mt-10">
            ...
            <p className="font-Amatic text-teal-800 text-5xl font-black mt-20">Ante Cualquie duda o consulta no dude en escribirnos, Intentaremos resolver su consulta a la Brevedad!</p>
          </div>
          <FormContacto/>
        </div>
      </>);
